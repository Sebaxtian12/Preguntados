...
public class AdapterDetalle extends BaseExpandableListAdapter {
    Context context;
    List<String> listGroup;
    HashMap<String, List<String>> listItem;
    public AdapterDetalle(Context context, List<String>listGorup, HashMap<String, List<String>>
            listItem){
        this.context=context;
        this.listGroup= listGorup;
