...
public class AyudaAdapter extends BaseExpandableListAdapter {
    ...
    public AyudaAdapter(Context context, List<String> expandableListTitle,
    ...
    public View getChildView(int listPosition, final int expandedListPosition,
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.litem_ayuda, null);
        }
    ...
    public View getGroupView(int listPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            LayoutInflater layoutInflater = (LayoutInflater) this.context.
                    getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = layoutInflater.inflate(R.layout.lgroup_ayuda, null);
        }
